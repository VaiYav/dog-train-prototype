...
> Високофідельний клікабельний приклад — [prototype/index.html](../../prototype/daily-focus.html) (перемикач **Control ↔ Daily Focus**).

### 1.1 Стрік-чіп на «Сьогодні» (variant)
```
┌───────────────────────────────┐
│  Привіт! Рекс 🐶      🔥 4  ⚙   │  ← було 🔥0 (control); variant: жива серія
├───────────────────────────────┤
│   Сьогодні · Чт   ◌ 1/3        │
...
```
🐶 DogTrain · 18:00
Час подбати про Рекса 🐾 — 3 завдання на сьогодні. Серія: 4 дні 🔥
(тап → «Сьогодні»)
```
...
При ~2 000 нових/міс (≈1 000/арм за 2 тижні) вікно **повністю потужне лише для ефекту ~+8–10 п.п.**; для +5 п.п. треба ~5–6 тижнів. Тому: **pre-register** план, на 2 тижні читаємо **директивно** (тренд + guardrails), а на повну потужність добиваємо, якщо тренд позитивний. Це і є валідація гіпотези без побудови повного функціоналу.
